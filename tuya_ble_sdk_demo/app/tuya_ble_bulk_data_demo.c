...
uint8_t TLD_Example_Data[64] =
    {
        0x01, /* TYPE:1 */
        0x00,
        0x3D, /* LENGTH: 0x003D = 61*/
        0x5F,
        0xC0,
        0xAF,
        0xDD, /* UNIX TIME: 0x5FC0AFDD = 1606463453 */
        0x14,
        0x02,
        0x00,
        0x04,
        ...
        0x00,
        0x00,
        0x0A, /* dp id: 20; dp type : value; dp len : 4; dp data : 10 */
        0x15,
        0x02,
        0x00,
        0x04,
        ...
        0x00,
        0x00,
        0x64, /* dp id: 21; dp type : value; dp len : 4; dp data : 100 */
        0x16,
        0x02,
        0x00,
        0x04,
        ...
        0x00,
        0x00,
        0x28, /* dp id: 22; dp type : value; dp len : 4; dp data : 40 */
        0x18,
        0x02,
        0x00,
        0x04,
        ...
        0x00,
        0x00,
        0x32, /* dp id: 24; dp type : value; dp len : 4; dp data : 50 ²½Êý*/
        0x19,
        0x02,
        0x00,
        0x04,
        ...
        0x00,
        0x00,
        0x46, /* dp id: 25; dp type : value; dp len : 4; dp data : 70 */
        0x69,
        0x00,
        0x00,
        0x0D,
        ...
        0x00,
        0x10,
        0x00, /* dp id: 105; dp type : raw; dp len : 18; dp data : raw data */
        0x01,
};
...
void tuya_ble_bulk_data_demo_handler(tuya_ble_bulk_data_request_t *p_data)
{
    ...
    {
        if (p_data->bulk_type != TEST_BULK_DATA_TYPE)
        { //Our test has only one type of bulk data.
    ...
    case TUYA_BLE_BULK_DATA_EVT_READ_BLOCK:
    {
        ...
        else
        {
            ...
            else
            {
                ...
                current_block_size = (current_block_number < (bulk_data_total_blocks - 1)) ? TEST_BULK_DATA_TYPE1_BLOCK_SIZE : (bulk_data_total_length - current_block_number * TEST_BULK_DATA_TYPE1_BLOCK_SIZE); //The data length of the last block may be less than TEST_BULK_DATA_TYPE0_BLOCK_SIZE.
