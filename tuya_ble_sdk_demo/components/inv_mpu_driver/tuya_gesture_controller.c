...
extern VOID_T tuya_gesture_controller_loop(VOID_T);
extern BOOL_T tuya_is_wait_bind(VOID_T);
extern bool ShortPressFlag;
...
STATIC UINT_T sg_wakeup_pin[1] = {GPIO_P14};
...
STATIC VOID_T __gesture_daq_end_cb(VOID_T)
{
    ...
    // TUYA_APP_LOG_INFO("tuya_mpu6050 get data");
}
...
{
    // hal_gpio_pin_init(REC_KEY_PIN, GPIO_INPUT);
    tuya_net_proc_init();
